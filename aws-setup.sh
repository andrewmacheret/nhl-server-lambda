 ...
 * New certificate in AWS Certificate Manager - nhl.XXX.com
 * New API in API gateway for /live/nhl
 * Route 53 mapping for nhl.XXX.com to the new API in API gateway
"
